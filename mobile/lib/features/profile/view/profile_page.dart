        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              // Description
              Text(
                "We're crafting a personalized profile experience just for you. Customize your learning preferences, track your progress, and make your educational journey truly yours!",
                ...
                child: ElevatedButton(
                  onPressed: () {
                    ScaffoldMessenger.of(context).showSnackBar(
                      SnackBar(
                        content: Text(
                          "We'll notify you when profile customization is available!",
                          style: context.textTheme.lexendBody.copyWith(
                            color: Colors.white,
                          ),
                        ),
